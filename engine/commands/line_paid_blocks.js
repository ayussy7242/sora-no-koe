...
const { normElement, normModality } = require("../normalize");
const {
  computeTokyoAscDeg,
  signIndexFromKey,
...
const { formatBunpu } = require("../presenter/line/paid/bunpu");
const { formatHouse } = require("../presenter/line/paid/house");
const { formatTsukiji } = require("../presenter/line/paid/tsukiji");
const { formatKinjitsu } = require("../presenter/line/paid/kinjitsu");
const { formatElements } = require("../presenter/line/paid/elements");
