...
const modSoraCoreV1 = safeRequire("./sora_core.v1");
const modSoraCoreV2 = safeRequire("./sora_core.v2");
...
const SORA_CORE_V1 = modSoraCoreV1?.SORA_CORE_V1 || null;
const SORA_CORE_V2 = modSoraCoreV2?.SORA_CORE_V2 || null;
