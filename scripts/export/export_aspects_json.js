...
/**
 * scripts/export/export_dictionaries_json.js
 *
 * Purpose:
 ...
 *
 * Usage:
 *   node scripts/export/export_dictionaries_json.js
 *   node scripts/export/export_dictionaries_json.js --out dist/dictionaries.bundle.v1.json
 *   node scripts/export/export_dictionaries_json.js --firebase
 *   node scripts/export/export_dictionaries_json.js --firebase --db sora-no-koe-db
 *   node scripts/export/export_dictionaries_json.js --firebase --dry-run
 *
 * Notes:
