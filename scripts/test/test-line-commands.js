...
/**
 * Usage:
 *  node scripts/test/test-line-commands.js --story ./tmp/stories/story.json --date 2026-01-17
 */
...
async function main() {
  ...
  if (!date || !storyPath) {
    console.error("Usage: node scripts/test/test-line-commands.js --date YYYY-MM-DD --story path/to/story.json");
    process.exit(1);
  }
  ...
  const svgPath = path.resolve("tmp/previews/sora_wheel_test.svg");
