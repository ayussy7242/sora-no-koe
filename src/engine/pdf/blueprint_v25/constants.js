...
const PAGE_INTROS = {
  sys: "この星図の形と重心を観測します。",
  map: "星の分布と重心の広がりを観測します。",
  obs: "生まれた瞬間の配置構図を観測します。",
  ang: "四つの軸が作る接続構造を観測します。",
  pln: "各天体が働く位置と出方を観測します。",
  lay: "天体の分布が作る層構造を観測します。",
  dep: "深層で働く引力と圧の配置を観測します。",
  asp: "天体同士を結ぶ接続と動きを観測します。",
  pat: "図全体に現れる構造の型を観測します。",
};
