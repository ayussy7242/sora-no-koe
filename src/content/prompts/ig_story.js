...
- Storyでは宇宙系絵文字を使ってよい。
- ただし絵文字は毎回必須ではない。
- 絵文字を使う場合は 0〜2個までにし、多用しない。
- 同じ絵文字や同じ位置を毎回繰り返さない。
- 絵文字候補は 🌙 ✨ 🌌 ⭐ ☄️ 🪐 など、宇宙トーンに合うものを使う。
- 絵文字だけで雰囲気を作らず、本文の自然さを優先する。
...
- 文末表現や締めの言い回しは固定しない。
- 同じ締め方が続かないように、複数の言い回しを自然に使い分ける。
...
望ましい終わり方:
- 明日8:10の投稿導線が自然に伝わる言い回し
- LINE配信中であることが自然に伝わる言い回し
を複数パターンで自然に使い分ける
