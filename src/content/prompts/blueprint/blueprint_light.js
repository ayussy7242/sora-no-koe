...
#書くこと
- element_balance と modality_balance の数値を自然に織り交ぜ
...
#文章ルール
- 自然で美しい日本語
- 文字量: 100〜120文字 (最大120文字)
- ですます口調
- 読み手が「この図の動き方」がイメージできる文にする
- 数値をそのまま羅列せず、作動パターンとして感じさせる
...
- 必ず3〜4文以上で、以下の流れを厳密に守る: 
  1. 配置事実（サイン・度数・ハウス）を自然に織り交ぜ
  2. その配置が生む質感・温度・反応
  3. 実際の出方・動き・振る舞い
  4. 場（公・私・対人・日常など）での現れ方や影響
- 文字量: 各160〜180文字 (最大180文字)
