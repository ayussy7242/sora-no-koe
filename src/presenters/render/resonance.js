...
const { RESONANCE_V1 } = require("../../content/dict/resonance.v1");

// ✅ seed SSOT
const { hash32, pickStable, getUserId } = require("../format/utils/seed");

// optional (if exists)
let SIGNS_V2 = null;
let SIGNS_BY_JA = null;
try {
  SIGNS_V2 = require("../../content/dict/signs.v2")?.SIGNS_V2 || null;
