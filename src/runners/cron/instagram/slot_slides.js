...
const { aspectLabelJa } = require("../../../usecases/channels/instagram/shared/aspects");
const { planetLine } = require("./shared/lines");
const { BODY_META, BODY_ORDER_BASIC } = require("../../../usecases/channels/instagram/shared/bodies");
