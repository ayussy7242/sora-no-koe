...
/**
 * Shared text helpers for AI outputs.
 * Includes PDF v2 helpers plus generic counters.
 */
...
function countCharsNoNewlines(text) {
...
function countLines(text, { ignoreBlank = true } = {}) {
  const lines = String(text || "").split("\n");
  if (!ignoreBlank) return lines.length;
