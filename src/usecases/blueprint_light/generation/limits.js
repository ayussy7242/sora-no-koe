...
const LIMITS_V2 = Object.freeze({
  ...
  roles: {
    ...
    deep_chiron: { min: 150, max: 170, minSentences: 3, maxSentences: 4 },
    deep_lilith: { min: 150, max: 170, minSentences: 3, maxSentences: 4 },
    deep_pattern: { min: 120, max: 160, minSentences: 3, maxSentences: 4 },
