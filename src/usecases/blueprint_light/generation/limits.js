...
const LIMITS_V2 = Object.freeze({
  ...
  roles: {
    ...
    deep_nodes_north: { min: 140, max: 160, minSentences: 3, maxSentences: 4 },
    deep_nodes_south: { min: 140, max: 160, minSentences: 3, maxSentences: 4 },
    deep_chiron: { min: 140, max: 160, minSentences: 3, maxSentences: 4 },
    deep_lilith: { min: 140, max: 160, minSentences: 3, maxSentences: 4 },
