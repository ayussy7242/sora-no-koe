...
const LIMITS_V2 = Object.freeze({
  core: {
    ...
    star_signature: { min: 420, max: 480, minSentences: 6, maxSentences: 7 },
  },
  map: {
  ...
  roles: {
    ...
    deep_nodes: { min: 150, max: 170, minSentences: 4, maxSentences: 4 },
    deep_chiron: { min: 150, max: 170, minSentences: 4, maxSentences: 4 },
    deep_lilith: { min: 150, max: 170, minSentences: 4, maxSentences: 4 },
    deep_pattern: { min: 160, max: 200, minSentences: 2, maxSentences: 3 },
    angle_intro: { min: 80, max: 120, minSentences: 2, maxSentences: 2 },
    angle: { min: 80, max: 120, minSentences: 2, maxSentences: 2 },
    axis_structure: { min: 420, max: 480, minSentences: 5, maxSentences: 5 },
  },
  aspects: {
    item: { min: 120, max: 150, minSentences: 2, maxSentences: 3 },
  },
  closing: {
